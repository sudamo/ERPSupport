...
namespace ERPSupport.SupForm.Bussiness
{
    ...
    public partial class frmBomCompare : Form
    {
        ...
        private void bnBottom_btnOK_Click(object sender, EventArgs e)
        {
            ...
            DALFactory.K3Cloud.DALCreator.PrdAllocation.UpdatePPBom(bSyn, _Type, _FentryId, strMTLNumber, strNewMTLNumber, dNewFZ, dNewMustQty, tNeedDate);
            ...
            DALFactory.K3Cloud.DALCreator.CommFunction.DM_Log_Local("生产用料清单修改", "配置//单据信息调整", strConTent);
