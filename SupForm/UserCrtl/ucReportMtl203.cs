...
namespace ERPSupport.SupForm.UserCrtl
{
    ...
    /// 盆子物料报表
    /// </summary>
    public partial class ucReportMtl203 : UserControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public ucReportMtl203()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void ucReportMtl203_Load(object sender, EventArgs e)
        {
            FillComboBox();
        }
        ...
        {
            dgv1.DataSource = CommonFunction.MTL203(SetFilter());
        }
