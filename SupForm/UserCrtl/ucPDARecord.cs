...
namespace ERPSupport.SupForm.UserCrtl
{
    ...
    /// PDA日志
    /// </summary>
    public partial class ucPDARecord : UserControl
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        /// <param name="e"></param>
        private void ucPDARecord_Load(object sender, EventArgs e)
        {
            FillComboBox();
        ...
        {
            cbxType.DataSource = CommonFunction.AssistantData();
            cbxType.DisplayMember = "FName";
            cbxType.ValueMember = "FValue";
            cbxType.SelectedIndex = 0;

            cbxOperator.DataSource = CommonFunction.ExceptionRecord();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            dt = CommonFunction.ExceptionRecord(cbxType.SelectedIndex, cbxType.SelectedValue.ToString(), cbxOperator.SelectedIndex, cbxOperator.SelectedValue.ToString(), txtNo.Text.Trim(), txtBarcode.Text.Trim(), txtCompany.Text.Trim(), dtpFrom.Value, dtpTo.Value, chbSucc.Checked, chbFailed.Checked);
            if (dt.Rows.Count > 0)//
            {
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            ...
            CommonFunction.SynBarcodr(dgv1.CurrentRow.Cells[3].Value.ToString(), strBillno, strBarcodes);
        ...
        {
            Common.frmInstockSynchr frmIs = new Common.frmInstockSynchr();
            frmIs.ShowDialog();
        }
